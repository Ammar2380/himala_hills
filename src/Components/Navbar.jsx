...
const Navbar = ({ cart = [], onCartOpen, showMarquee = true }) => {
  ...
  // Marquee animation
  useEffect(() => {
    if (!showMarquee) return; // Skip marquee if false
          ...
          >
            <div className="relative flex flex-col justify-between min-h-full p-8 pt-32 pb-12">
              <div className="w-full">
                <p className="text-[10px] font-black tracking-[0.4em] text-[#FFC936] uppercase mb-8">
                  Navigation
                </p>
                  ...
                  {sections.map((section, i) => (
                    ...
                    >
                      <div className="flex items-end gap-4">
                        <span className="text-xs font-mono text-[#FFC936]/40 mb-1">
                          0{i + 1}
                        </span>
